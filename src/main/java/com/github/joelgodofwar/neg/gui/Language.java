...
public enum Language {
	...
	/**
	 * Returns an ItemStack representing the custom player head for this language.
	 *
	 * @return the configured ItemStack with the language's head texture
	 */
	public ItemStack getHead() {
		return HeadUtils.makeHead(langNameInEnglish, texture, uuid, new ArrayList<>(), null);
	}
