package com.github.joelgodofwar.neg.utils;
...
public class VersionChecker {
	...
	public VersionChecker(NoEndermanGrief plugin, int projectID, String githubURL) {
		this.neg = plugin;
	...
	public boolean checkForUpdates() throws Exception {
		...
		neg.LOGGER.debug(ChatColor.RED + "currentVersion=" + currentVersion);
		neg.LOGGER.debug(ChatColor.RED + "releaseVersion=" + releaseVersion);
		neg.LOGGER.debug(ChatColor.RED + "developerVersion=" + developerVersion);
