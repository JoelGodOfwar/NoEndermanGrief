...
public class VersionChecker {
    ...
    public boolean checkForUpdates2() throws Exception {
    	URL url = new URL(githubURL);
    ...
    public String getDownloadLink() {
    	if (recommendedVersion.equalsIgnoreCase("release")) {
            return "https://www.spigotmc.org/resources/no-enderman-grief2.71236/history";
        } else if (recommendedVersion.equalsIgnoreCase("developer")) {
            return "https://discord.com/channels/654087250665144321/654444482372173875";
        } else {
            return "UpToDate";
        }
    }
