...
public class SettingsBook_v1_16_R3 implements SettingsBook{
	
	
	public ItemStack giveBook() {
		ItemStack book = new ItemStack(Material.WRITTEN_BOOK); //Create bukkit book
		net.minecraft.server.v1_16_R3.ItemStack stack = CraftItemStack.asNMSCopy(book); //Get the nms version
